   ...
   <div id="content_wrap">
    <div id="content">
     ...
     <div id="right_wrap">
      <div id="right">
       <div id="tab_content">
        <a<? if($tab_active == 0) echo ' class="active"'; ?> href="/tasks" onclick="nav.go(this); return false;">
         Весь список 
        </a>
        <a<? if($tab_active == 1) echo ' class="active"'; ?> href="/tasks?cat=1" onclick="nav.go(this); return false;">
         "Мне нравится"
        </a>
         <a<? if($tab_active == 6) echo ' class="active"'; ?> href="/tasks?cat=1&act=reposts" onclick="nav.go(this); return false;">
         "Рассказать друзьям"
        </a>
        <a<? if($tab_active == 2) echo ' class="active"'; ?> href="/tasks?cat=2" onclick="nav.go(this); return false;">
         Комментарии
        </a>
        <a<? if($tab_active == 3) echo ' class="active"'; ?> href="/tasks?cat=3" onclick="nav.go(this); return false;">
         Подписки
        </a>
        <a<? if($tab_active == 4) echo ' class="active"'; ?> href="/tasks?cat=4" onclick="nav.go(this); return false;">
         Сообщества
        </a>
        <a<? if($tab_active == 5) echo ' class="active"'; ?> href="/tasks?cat=5" onclick="nav.go(this); return false;">
         Опросы
        </a>
        <div id="tasks_search">
       ...
       <div id="tasks_list">
        ...
        <? if($tab_active == 0) { ?><div id="top_tasks_title_wrap"><div id="top_tasks_title">ТОП ЗАДАНИЙ</div></div>
        <? echo $tasks->all_new(array(
         'vk_id' => $vkid,
         'top' => 1
        )); ?><? } ?>
        
        <? if($tab_active == 0) { ?><div id="other_tasks_title_wrap"><div id="other_tasks_title">ОБЫЧНЫЕ ЗАДАНИЯ</div></div><? } ?>
